import json
from processen import settings
from processen import get_city_coordinaten
import sys
...
def add_trip():
    """
    Add a new trip with predefined details.
    Returns a message confirming the new trip.
    """
    validator = Validator()
    data = load_data()
    ...
    new_trip = {
        ...
        "distance_unit": validator.validate_temperature_unit(),
    ...
    save_data(data)
    return f"New trip '{new_trip['Title']}' has been added."
